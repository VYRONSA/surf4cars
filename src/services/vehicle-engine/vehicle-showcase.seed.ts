...
function buildRecord(input: SeedInput): UnifiedVehicleRecord {
  ...
  return {
    ...
    dealer: {
      ...
      /* The showcase seed is demonstration data and must not manufacture trust signals either —
         AGENTS.md requires demonstration records to be distinguishable, not more convincing. */
